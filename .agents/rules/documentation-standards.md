---
trigger: always_on
description: Documentation standards, Architecture Decision Record (ADR) conventions, and code comment rules.
---
...
- Add JSDoc comments to public utilities in `src/lib/` and reusable hooks/components.
